...
git clone --bare https://$(bw get username da37ced2-546e-4481-b9f7-accc01382414):$(bw get password da37ced2-546e-4481-b9f7-accc01382414)@github.com/rokejulianlockhart/$(Get-Variable -Name 'Username' | Select-Object -ExpandProperty Value).git
